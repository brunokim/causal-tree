...
export class Crdt {
  ...
  renderAtom(atom, cursor) {
    ...
    let atomEl = $("<div>")
      .addClass("atom")
      .append($("<div>").addClass("atom-id").text(idString(atom["ID"])))
      .append($("<div>").addClass("atom-value").text(atom["Value"]))
      .append($("<div>").addClass("atom-cause").text(idString(atom["Cause"])));
  ...
  controls() {
    return $("<div>")
      ...
      .append(
        $("<button>")
          .text("-100")
          .click(() => this.addTime(-100))
      )
      .append(
        $("<button>")
          .text("-10")
          .click(() => this.addTime(-10))
      )
      .append(
        $("<button>")
          .text("-1")
          .click(() => this.addTime(-1))
      )
      .append(
        $("<input>")
          .attr("type", "number")
